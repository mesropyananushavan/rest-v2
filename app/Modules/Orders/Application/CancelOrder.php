...
final class CancelOrder
{
    ...
    public function __invoke(int $orderId): Order
    {
        ...
        $order = $this->runOrderTransaction(function () use ($branchId, $orderId, $startedAt): Order {
            $order = $this->lockOpenOrderForUpdate($orderId, $branchId, 'orders.cancel', $startedAt, []);
