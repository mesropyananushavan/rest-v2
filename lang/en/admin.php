...
return [
    ...
    'audit_logs' => [
        ...
        'heading' => 'Audit log',
        'subtitle' => 'Review recorded admin actions inside a required date window of at most :days days.',
        'filters' => [
            'date_from' => 'From',
            'date_to' => 'To',
            'actor_id' => 'Actor ID',
            'actor_placeholder' => 'Example: 12',
            'action' => 'Action',
            'action_placeholder' => 'menu.category.archived',
            'target_type' => 'Target type',
            'target_type_placeholder' => 'menu_category',
            'branch' => 'Branch',
            'all_assigned_branches' => 'All assigned branches',
        ],
        'actions' => [
        ...
        'detail' => [
            ...
            'heading' => 'Audit row #:id',
            'subtitle' => 'Stored before and after values are rendered as escaped text.',
            'summary' => 'Summary',
            'before_json' => 'Before',
            'after_json' => 'After',
        ],
        'empty' => [
            ...
            'body' => 'Change the date window or filters to review a different bounded set.',
        ],
        'values' => [
            'system_actor' => 'System',
            'unknown_actor' => 'Unknown actor #:id',
            'no_branch' => 'No branch',
            'unknown_branch' => 'Unknown branch #:id',
            'empty' => 'Not recorded',
            'empty_json' => 'No JSON payload recorded.',
        ],
        'errors' => [
            'date_required' => 'Choose both dates for the audit window.',
            'date_invalid' => 'Use a valid date in YYYY-MM-DD format.',
            'date_order' => 'The end date must be on or after the start date.',
            'window_too_large' => 'The audit window cannot exceed :days calendar days.',
            'actor_invalid' => 'Actor ID must be a positive number.',
            'action_invalid' => 'Action must be a valid audit code.',
            'target_type_invalid' => 'Target type must be a valid audit code.',
            'branch_invalid' => 'Branch must be a valid assigned branch.',
            'branch_not_allowed' => 'You cannot filter audit rows by an unassigned branch.',
        ],
    ],
    'errors' => [
